  <!-- Footer -->
  <footer class="border-theme-24 text-white py-4">
      <div class="max-w-screen-xl p-4 py-6 mx-auto lg:py-5 md:p-8 lg:p-10">
          <div class="text-center">
              <a href="#"
                  class="flex items-center justify-center mb-5 text-2xl font-semibold text-white-900 dark:text-white">
                  Wisata Lampung
              </a>
              <span class="block text-sm text-center text-gray-500 dark:text-gray-400">
                  © 2023 Wisata Lampung. All Rights Reserved. Developer with TeamTwice.
              </span>
              <ul class="flex justify-center mt-5 space-x-5"> <!-- Mengubah 'class' menjadi 'ul' -->
                  <li>
                      <a href="#"
