                ...
                <div class="hidden xl:flex flex-col min-h-screen">
                    ...
                    <div class="my-auto">
                        ...
                        <div class="-intro-x mt-5 text-lg text-white">
                            Manage all your wisata lampung accounts in one place
                        </div>
                    </div>
                </div>
                <!-- END: Register Info -->
                ...
                <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                    <div
                        ...
                        <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                            <button class="button button--lg w-full xl:w-32 text-white bg-theme-1 xl:mr-3"><a
                                    href="{{ route('Register') }}"
                                    class="top-menu {{ Route::is('Register') ? 'top-menu--active' : '' }}">Register</a>
                            </button>
                            <button
                                class="button button--lg w-full xl:w-32 text-gray-700 border border-gray-300 mt-3 xl:mt-0">
                                <a href="{{ route('Login') }}"
                                    class="top-menu {{ Route::is('Login') ? 'top-menu--active' : '' }}">Sign
                                    in</a>
                            </button>
                        </div>
                    </div>
