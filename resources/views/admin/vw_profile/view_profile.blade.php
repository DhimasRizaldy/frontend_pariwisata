...
@section('title_template')
    <title>WisataLampung | Data Profile</title>
@endsection
{{-- end title --}}
        ...
        <table class="table table-report table-report--bordered display datatable w-full">
            <thead>
                <tr>
                    ...
                    <th class="border text-center whitespace-no-wrap">Jenis Kelamin</th>
                    <th class="border text-center whitespace-no-wrap">Alamat</th>
                    <th class="border text-center whitespace-no-wrap">Foto Profile</th>
                    <th class="border text-center whitespace-no-wrap">Actions</th>
                </tr>
            </thead>
            <tbody>
                @foreach ($result->data->profile as $output)
                    <tr class="border">
                        ...
                        <td class="text-center border">{{ $output->nama }}</td>
                        <td class="text-center border">{{ $output->jenis_kelamin }}</td>
                        <td class="text-center border">{{ $output->alamat }}</td>
                        <td class="text-center border">{{ $output->foto_profile }}</td>
