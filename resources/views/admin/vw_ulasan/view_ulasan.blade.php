...
@section('title_template')
    <title>WisataLampung | Data Ulasan</title>
@endsection
{{-- end title --}}
        ...
        <table class="table table-report table-report--bordered display datatable w-full">
            <thead>
                <tr>
                    ...
                    <th class="border text-center whitespace-no-wrap">Judul</th>
                    <th class="border text-center whitespace-no-wrap">Isi Ulasan</th>
                    <th class="border text-center whitespace-no-wrap">Foto Ulasan</th>
                    <th class="border text-center whitespace-no-wrap">Actions</th>
                </tr>
            </thead>
            <tbody>
                @foreach ($result->data->ulasan as $output)
                    <tr class="border">
                        ...
                        <td class="text-center border">{{ $output->tanggal_ulasan }}</td>
                        <td class="text-center border">{{ $output->judul }}</td>
                        <td class="text-center border">{{ $output->isi_ulasan }}</td>
                        <td class="text-center border">{{ $output->foto_ulasan }}</td>
                        <td class="border w-5">
