...
@section('title_template')
    <title>WisataLampung | Data Wisata</title>
@endsection
{{-- end title --}}
        ...
        <table class="table table-report table-report--bordered display datatable w-full">
            <thead>
                <tr>
                    ...
                    <th class="border text-center whitespace-no-wrap">Nama</th>
                    <th class="border text-center whitespace-no-wrap">Kategori</th>
                    <th class="border text-center whitespace-no-wrap">Daerah</th>
                    <th class="border text-center whitespace-no-wrap">Jam Operasi</th>
                    <th class="border text-center whitespace-no-wrap">Harga</th>
            ...
            <tbody>
                @foreach ($result->data->wisata as $output)
                    <tr class="border">
                        <td class="text-center border">{{ $loop->iteration }}</td>
                        <td class="text-center border">{{ $output->id }}</td>
                        <td class="text-center border">{{ $output->nama_wisata }}</td>
                        <td class="text-center border">{{ $output->kategoriId }}</td>
                        <td class="text-center border">{{ $output->daerahId }}</td>
                        <td class="text-center border">{{ $output->jam_operasi }}</td>
                        <td class="text-center border">{{ $output->harga_tiket }}</td>
                        <td class="text-center border">{{ $output->tanggal }}</td>
